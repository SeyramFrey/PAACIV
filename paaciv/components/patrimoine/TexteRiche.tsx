...
const STYLES =
  'max-w-none text-encre-t ' +
  '[&_h2]:mt-6 [&_h2]:mb-2 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:text-ocre ' +
  '[&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:font-serif [&_h3]:text-xl [&_h3]:text-ocre ' +
  '[&_p]:mb-3 [&_ul]:mb-3 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:mb-3 [&_ol]:list-decimal [&_ol]:pl-6 ' +
  '[&_li]:mb-1 [&_a]:text-ocre [&_a]:underline ' +
